...
<div x-show="showCreateModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <!-- Background overlay -->
        <div class="fixed inset-0 bg-dark/50 transition-opacity" @click="closeCreateModal()"></div>
        ...
        <div x-show="showCreateModal" x-transition:enter="ease-out duration-300"
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <button @click="closeCreateModal()" class="text-font/40 hover:text-font/60">
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
                ...
                <!-- Nome -->
                <div>
                    <label for="create_name" class="block text-sm font-medium text-font mb-1">
                        Nome Completo *
                    </label>
                ...
                <!-- Email -->
                <div>
                    <label for="create_email" class="block text-sm font-medium text-font mb-1">
                        Email *
                    </label>
                ...
                <!-- Telefone -->
                <div>
                    <label for="create_phone" class="block text-sm font-medium text-font mb-1">
                        Telefone
                    </label>
                ...
                <!-- Senha -->
                <div>
                    <label for="create_password" class="block text-sm font-medium text-font mb-1">
                        Senha *
                    </label>
                ...
                <!-- Confirmar Senha -->
                <div>
                    <label for="create_password_confirmation" class="block text-sm font-medium text-font mb-1">
                        Confirmar Senha *
                    </label>
                ...
                <!-- Função -->
                <div>
                    <label for="create_role" class="block text-sm font-medium text-font mb-1">
                        Função *
                    </label>
                ...
                <!-- Status -->
                <div>
                    <label for="create_status" class="block text-sm font-medium text-font mb-1">
                        Status *
                    </label>
