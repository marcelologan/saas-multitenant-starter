                ...
                <div class="glass-effect rounded-2xl p-6 max-w-md">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-white/80 text-sm">CEO, Confecções Bella</p>
                        </div>
                    </div>
                    <p class="text-white/90 italic">
                        "O Fashion Manager revolucionou nossa produção. Aumentamos 40% nossa eficiência em apenas 3
                        meses."
                    </p>
                </div>
            </div>
            ...
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="email" name="email" type="email" autocomplete="email" required
                                    value="{{ old('email') }}"
                                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-colors text-gray-900 placeholder-gray-500"
                        ...
                        <div>
                            <button type="submit"
                                class="w-full btn-gradient py-3 px-4 rounded-xl text-white font-semibold text-lg transition-all transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                                Entrar
                            </button>
                        </div>
                    </form>
